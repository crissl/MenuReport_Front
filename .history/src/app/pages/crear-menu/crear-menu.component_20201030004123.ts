...
export class CrearMenuComponent implements OnInit, OnDestroy {
  ...
  constructor(private menuService: MenuService, private personalDataService: PersonalDataService, private spinner: NgxSpinnerService,
    private route: ActivatedRoute, private router: Router, private messageService: MessageService, private formBuilder: FormBuilder, private datePipe: DatePipe, priva toastr: ToastrService, private http: HttpClient, private _sanitizer: DomSanitizer) {
    this.initializar();
    this.spinner.show();
  ...
  crearContenido() {
    ...
    uploadData.append('usuarioCrea',this.registroContenido.value.usuarioCrea);
