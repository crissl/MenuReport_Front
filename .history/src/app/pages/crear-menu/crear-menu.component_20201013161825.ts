...
export class CrearMenuComponent implements OnInit, OnDestroy {
  ...
  constructor(private menuService: MenuServiceprivate personalDataService: PersonalDataService, private spinner: NgxSpinnerService,
  ...
  getNoticias() {
    this.restservices.get("noticias/estado_noticia/").subscribe(
      (data) => {
        this.noticias = data;
