...
export class CrearMenuComponent implements OnInit, OnDestroy {
  ...
  crearContenido() {
    ...
    uploadData.append('idF', this.registroContenido.setValue.toString(this.menus.idFidF) );
    uploadData.append('codigoMenuF', this.menus.codigoMenuF = this.registroContenido.value);
    uploadData.append('descripcion', this.menus.descripcion = this.registroContenido.value);
    uploadData.append('link', this.menus.link = this.registroContenido.value);
    uploadData.append('imagen', this.selectedFile);
    this.selectedFile.imageName = this.selectedFile.name;
    uploadData.append('fechaCrea', this.menus.fechaCrea = this.registroContenido.value);
    uploadData.append('usuarioCrea', this.menus.usuarioCrea = this.registroContenido.value);
