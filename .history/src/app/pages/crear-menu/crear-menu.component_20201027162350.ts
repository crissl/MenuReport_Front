...
export class CrearMenuComponent implements OnInit, OnDestroy {
  ...
  initializar(): void {
    ...
    this.registroMenuPadre = new FormGroup({
      ...
      codigoMenu:new FormControl(0),
      idF: new FormControl(0),
      codigoMenuF: new FormControl(0),
...
crearMenu() {
  ...
  console.log("datos padre: ", this.registroMenuPadre.get.name());
  this.datosFormularios= {
