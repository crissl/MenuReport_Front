...
crearMenu() {
  ...
  const sistemaAdd = JSON.stringify(registroMenuPadre);

  this.selectedFile.imageName  = this.selectedFile.name;

 this.formBuilder = this.registroMenuPadre.value;
  this.http.post( 'http://localhost:8083/menus/crear', uploadData, {observe: 'response'})
//  this.menuService
