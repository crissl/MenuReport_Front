...
export class CrearMenuComponent implements OnInit, OnDestroy {
  ...
  crearContenido() {
    ...
    uploadData.append('codigoMenuF', this.registroContenido.value.idF);
    uploadData.append('nombre', this.registroContenido.value.idF);
    uploadData.append('descripcion', this.registroContenido.value.idF);
    uploadData.append('estado', this.registroContenido.value.idF);
    uploadData.append('link',this.registroContenido.value.idF);
    uploadData.append('imagen',this.registroContenido.value.idF);
    this.selectedFile.imageName = this.registroContenido.value.idF;
    uploadData.append('fechaCrea', this.registroContenido.value.idF);
    uploadData.append('usuarioCrea', this.registroContenido.value.idF);
